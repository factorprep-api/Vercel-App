...
import { ClipboardList, Play, ChevronDown, ChevronUp, Video, Save, CheckCircle, MessageSquare } from 'lucide-react';
...
function findAthleteRowByEmail(athletesData, email) {
  ...
  for (let i = 1; i < athletesData.length; i++) {
    if (String(athletesData[i] && athletesData[i][emailCol] || '').trim().toLowerCase() === email.toLowerCase()) return i;
  }
  return null;
}
                          ...
                          <div key={idx} className="pv-set-row">
                            ...
                            <div className="pv-inputs">
                              <div className="pv-input-group">
                                ...
                                <input type="number" className="pv-input" placeholder
cat > src/pages/ProgramViewer.jsx << 'EOF'
import { useState, useEffect, useMemo } from 'react';
