  ...
  return (
    <div style={{ fontFamily: '"Roboto Flex", sans-serif', display: 'flex', height: '100vh', backgroundColor: DESIGN.cardBackground }}>
      ...
      <div style={{ 
        width: TOOLBAR_WIDTH, 
        backgroundColor: '#fff', 
        borderRight: `1px solid ${DESIGN.bodyGray}`, 
        display: 'flex', 
        ...
        {/* Stroke Width */}
        <div style={{ marginBottom: '20px' }}>
          <label style={{ fontSize: '13px', fontWeight: '700', color: DESIGN.darkText, display: 'block', marginBottom: '8px' }}>LINE THICKNESS: {selectedToolConfig.strokeWidth}px</label>
          <input 
            type="range" 
            min="1" 
            max="10" 
